...
{
    /// <summary>
    /// Campground attribute formatter interface
    /// </summary>
    public partial interface ICampgroundAttributeTypeFormatter
    {
        /// <summary>
        /// Formats attributes
        /// </summary>
        ...
        string FormatAttributes(Campground campground, string attributesXml);
