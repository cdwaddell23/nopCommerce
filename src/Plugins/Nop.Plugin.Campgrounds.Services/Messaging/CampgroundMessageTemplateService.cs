...
namespace Nop.Plugin.Campgrounds.Services.Messaging
{
    ...
    /// </summary>
    public partial class CampgroundMessageTemplateService : ICampgroundMessageTemplateService
    {
        #region Constants
        ...
        public CampgroundMessageTemplateService(ICacheManager cacheManager,
