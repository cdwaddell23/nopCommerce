...
;(function($){$.fn.camera = function(opts, callback) {
	...
	var defaults = {
		...
		cols				: 6,		
		easing				: 'easeInOutSine',	//for the complete list http://jqueryui.com/demos/effect/easing.html		
		...
		height				: '34.89%',	//here you can type pixels (for instance '300px'), a percentage (relative to the width of the slideshow, for instance '50%') or 'auto'		
