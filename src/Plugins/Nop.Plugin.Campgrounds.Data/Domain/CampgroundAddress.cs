...
{
    public partial class CampgroundAddress : BaseEntity, ICloneable
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the fully qualified address
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets address longitude
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets GeoLocation URL
        /// </summary>
        public string GoogleGeocodeURL { get; set; }

        /// <summary>
        /// Gets or sets the reservations number
        /// </summary>
        ...
        public object Clone()
        {
            var addr = new CampgroundAddress
            {
